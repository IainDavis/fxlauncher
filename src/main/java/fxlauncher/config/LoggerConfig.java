...
public class LoggerConfig {
  ...
  private static final UnaryOperator<String> CREATE_HANDLER_FAILED_MSG =
      logfile ->
          String.format(
              "Unable to log to '%s'. Logging to default location instead: %s",
              logfile, Paths.get(".").toAbsolutePath());
}
